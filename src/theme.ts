...
export const rules = [
    {
        ...
        content_margin: 8,
        'layer0.texture': 'Ibira Theme/textures/actions/close.png',
    ...
    },
    {
        ...
        content_margin: [8, 8],
        'layer0.texture': 'Ibira Theme/textures/actions/history.png',
        'layer0.tint': 'var(accent)',
        'layer0.opacity': 1,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/tree/disclosure_collapsed.png',
    ...
    },
    {
        class: 'disclosure_button_control',
        attributes: ['expanded'],
        'layer0.texture': 'Ibira Theme/textures/tree/disclosure_expanded.png',
    ...
    {
        class: 'icon_folder',
        'layer0.texture': 'Ibira Theme/textures/tree/folder_closed.png',
        'layer0.tint': 'var(sidebarIconFolderColor)',
        'layer0.opacity': 1,
        content_margin: [9, 9],
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/tree/folder_open.png',
        'layer0.tint': 'var(sidebarIconFolderExpandedColor)',
        'layer0.opacity': 1,
        content_margin: [9, 9],
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/tree/folder_dup.png',
        'layer0.tint': 'var(sidebarIconFolderColor)',
        'layer0.opacity': 1,
        content_margin: [9, 9],
    },
    {
        ...
        'layer0.texture': {
            keyframes: [
                'Ibira Theme/textures/spinner11.png',
                'Ibira Theme/textures/spinner10.png',
                'Ibira Theme/textures/spinner9.png',
                'Ibira Theme/textures/spinner8.png',
                'Ibira Theme/textures/spinner7.png',
                'Ibira Theme/textures/spinner6.png',
                'Ibira Theme/textures/spinner5.png',
                'Ibira Theme/textures/spinner4.png',
                'Ibira Theme/textures/spinner3.png',
                'Ibira Theme/textures/spinner2.png',
                'Ibira Theme/textures/spinner1.png',
                'Ibira Theme/textures/spinner.png',
            ],
            loop: true,
            frame_time: 0.08,
        },
    ...
    {
        class: 'icon_regex',
        'layer0.texture': 'Ibira Theme/textures/find/regex.png',
    ...
    {
        class: 'icon_case',
        'layer0.texture': 'Ibira Theme/textures/find/case_sensitive.png',
        'layer0.tint': 'var(buttonIconFileColor)',
        'layer0.opacity': {
            target: 0.5,
            speed: 5,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/find/whole_word.png',
        'layer0.tint': 'var(buttonIconFileColor)',
        'layer0.opacity': {
            target: 0.5,
            speed: 5,
    ...
    {
        class: 'icon_wrap',
        'layer0.texture': 'Ibira Theme/textures/find/wrap.png',
        'layer0.tint': 'var(buttonIconFileColor)',
        'layer0.opacity': {
            target: 0.5,
            speed: 5,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/find/in_selection.png',
        'layer0.tint': 'var(buttonIconFileColor)',
        'layer0.opacity': {
            target: 0.5,
            speed: 5,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/find/highlight_matches.png',
        'layer0.tint': 'var(buttonIconFileColor)',
        'layer0.opacity': {
            target: 0.5,
            speed: 5,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/find/preserve_case.png',
        'layer0.tint': 'var(buttonIconFileColor)',
        'layer0.opacity': {
            target: 0.5,
            speed: 5,
    ...
    {
        class: 'icon_context',
        'layer0.texture': 'Ibira Theme/textures/find/in_context.png',
        'layer0.tint': 'var(buttonIconFileColor)',
        'layer0.opacity': {
            target: 0.5,
            speed: 5,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/find/use_buffer.png',
        'layer0.tint': 'var(buttonIconFileColor)',
        'layer0.opacity': {
            target: 0.5,
            speed: 5,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/find/use_gitignore.png',
        'layer0.tint': 'var(buttonIconFileColor)',
        'layer0.opacity': {
            target: 0.5,
            speed: 5,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/navigation/arrow_right.png',
        'layer0.tint': 'var(accent)',
        'layer0.opacity': 0.4,
        'layer0.inner_margin': 0,
        content_margin: [12, 12],
    ...
    },
    {
        class: 'fold_button_control',
        attributes: ['expanded'],
        'layer0.texture': 'Ibira Theme/textures/navigation/arrow_down.png',
        'layer0.tint': 'var(accent)',
        content_margin: [12, 12],
    },
    {
    ...
    },
    {
        ...
        'layer1.texture': 'Ibira Theme/textures/input/search.png',
    ...
    },
    {
        class: 'close_button',
        attributes: ['dirty'],
        'layer0.texture': 'Ibira Theme/textures/tab/dirty_pencil.png',
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/overlay/shadow.png',
        'layer0.opacity': 1.0,
        'layer1.inner_margin': [20, 16, 20, 32],
        'layer1.texture': 'Ibira Theme/textures/overlay/background.png',
        'layer1.tint': 'var(overlayControlBackground)',
        'layer1.opacity': 1.0,
        'layer2.inner_margin': [20, 16, 20, 32],
        'layer2.texture': 'Ibira Theme/textures/overlay/border.png',
    ...
    },
    {
        class: 'vcs_branch_icon',
        settings: ['show_git_status_in_status_bar'],
        'layer0.texture': 'Ibira Theme/textures/actions/branch.png',
        content_margin: 8,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/actions/sidebar.png',
        content_margin: 8,
        'layer0.tint': 'var(statusbarIconColor)',
        'layer0.inner_margin': 2,
        'layer0.opacity': 1,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/tab/dirty_dot.png',
    },
    {
        class: 'tab_close_button',
        attributes: ['!hover'],
    ...
    },
    {
        ...
        'layer0.texture':
            'Ibira Theme/textures/navigation/arrow_left_small.png',
    ...
    },
    {
        ...
        'layer0.texture':
            'Ibira Theme/textures/navigation/arrow_right_small.png',
        'layer0.tint': 'var(tabNavigationColor)',
        'layer0.opacity': {
            target: 0.5,
            speed: 5,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/actions/more.png',
        'layer0.tint': 'var(tabMoreColor)',
        'layer0.opacity': {
            target: 0.5,
            speed: 5,
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/vcs/vcs_untracked.png',
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/vcs/vcs_modified.png',
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/vcs/vcs_added.png',
    ...
    },
    {
        ...
        'layer0.texture': 'Ibira Theme/textures/vcs/vcs_staged.png',
...
export function getThemeDefault(): ThemeSetting {
    return {
        extends: 'Ibira Theme.hidden-theme',
        variables,
        rules,
    };
}
